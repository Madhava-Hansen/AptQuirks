...
My app has a custom built user authentication system that uses BCrypt password hashing to verify a users password without saving the password to database.
