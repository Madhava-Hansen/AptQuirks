  ...
  static getDerivedStateFromProps(nextProps) {
    ...
    if (currentConversation) {
      usernameObject.username =
        currentConversation.receiver_username === currentUser.username
          ? currentConversation.sender_username
          : currentConversation.receiver_username;
    ...
    return (
      <div className="message-index-div">
        <div className="message-index-container">
          ...
          <ul className="messages-index">{messages}</ul>
        </div>
