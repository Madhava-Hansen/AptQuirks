...
export const Walkscore = ({ data }) => {
  ...
  useEffect(() => {
    {
      data &&
        data.third_party_ap_is.address &&
        ...
        <div className="Walkscore">
          ...
          <div className="Walkscore-scoreWrapper">
            <div className="Walkscore-badgeWrapper">
              <img
                className="Walkscore-badge"
                src={`//pp.walk.sc/badge/walk/score/${walkscoreData.walkscore}.svg`}
              ></img>
              <h3 className="Walkscore-badgeDescription">
            ...
            {walkscoreData.transit && (
              <div className="Walkscore-badgeWrapper">
                <img
                  className="Walkscore-badge"
                  src={`//pp.walk.sc/badge/transit/score/${walkscoreData.transit.score}.svg`}
                />
                <p className="Walkscore-badgeDescription">
            ...
            {walkscoreData.bike && (
              <div className="Walkscore-badgeWrapper">
                <img
                  className="Walkscore-badge"
                  src={`//pp.walk.sc/badge/bike/score/${walkscoreData.bike.score}.svg`}
                />
                <p className="Walkscore-badgeDescription">
